...
export function ChatWidget({ me }: { me: Perfil }) {
  ...
  // Grupos abiertos para mandar un mensaje sin ser miembro: al mandar el
  ...
  // compartido — se le crea una conversación aparte, privada, solo entre
  // esta persona y los miembros actuales del grupo (o reutiliza la que ya
  // exista de un envío anterior). Devuelve el id real al que hay que
  // mandar el mensaje (null si falló).
